...
namespace Rei.Random {
    ...
    public class SFMT : RandomBase {
        ...
        /// <summary>
        /// 奺梫慺傪128bit偲偟偨偲偒偺撪晹忬懺儀僋僩儖偺屄悢丅
        /// </summary>
        protected int N;
        /// <summary>
        /// 奺梫慺傪32bit偲偟偨偲偒偺撪晹忬懺儀僋僩儖偺屄悢丅
        /// </summary>
        protected int N32;
        /// <summary>
        /// 寁嶼偺崅懍壔梡丅
        ...
        /// <summary>
        /// 撪晹忬懺儀僋僩儖偺偆偪丄師偵棎悢偲偟偰巊梡偡傞僀儞僨僢僋僗丅
        /// </summary>
        protected int idx;
        ...
        /// <summary>
        /// 尰嵼帪崗傪庬偲偟偨丄(2^19937-1)廃婜偺SFMT媅帡棎悢僕僃僱儗乕僞乕傪弶婜壔偟傑偡丅
        /// </summary>
        public SFMT() : this(Environment.TickCount, 19937) { }

        /// <summary>
        /// seed傪庬偲偟偨丄(2^19937-1)廃婜偺媅帡棎悢僕僃僱儗乕僞乕傪弶婜壔偟傑偡丅
        /// </summary>
        public SFMT( int seed ) : this(seed, 19937) { }

        /// <summary>
        /// seed傪庬偲偟偨丄period偱昞偝傟傞廃婜偺媅帡棎悢僕僃僱儗乕僞乕傪弶婜壔偟傑偡丅
        /// </summary>
        public SFMT( int seed, MTPeriodType period ) : this(seed, (int)period) { }

        /// <summary>
        /// seed傪庬偲偟偨丄(2^mexp-1)廃婜偺媅帡棎悢僕僃僱儗乕僞乕傪弶婜壔偟傑偡丅
        /// mexp偼607,1279,2281,4253,11213,19937,44497,86243,132049,216091偺偄偢傟偐偱偁傞昁梫偑偁傝傑偡丅
        /// </summary>
